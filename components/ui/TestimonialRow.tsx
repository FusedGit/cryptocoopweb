...
const TwitterCard = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <motion.a
      ...
      className="block bg-white rounded-2xl p-5 border border-gray-200 hover:border-gray-300 transition-all cursor-pointer w-[380px] flex-shrink-0"
    >
...
const RedditCard = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <motion.a
      ...
      onHoverStart={() => setIsHovered(true)}
      onHoverEnd={() => setIsHovered(false)}
      className="block bg-white rounded-xl p-5 border border-gray-300 hover:border-orange-400 transition-all cursor-pointer w-[380px] flex-shrink-0"
    >
...
const TrustpilotCard = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <motion.a
      ...
      onHoverStart={() => setIsHovered(true)}
      onHoverEnd={() => setIsHovered(false)}
      className="block bg-white rounded-xl p-5 border border-gray-200 hover:border-green-400 transition-all cursor-pointer w-[380px] flex-shrink-0"
    >
...
export default function TestimonialRow({ testimonials, direction = 'left', speed = 50 }: TestimonialRowProps) {
    ...
    <div className="relative overflow-hidden">
      ...
      >
        {duplicatedTestimonials.map((testimonial, index) => {
          ...
          return (
            <div key={`${testimonial.username}-${index}`}>
